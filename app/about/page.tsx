  ...
  return (
    <div className="prose max-w-none pb-8 pt-10 dark:prose-invert">
      ...
      <p>
        ...
        including being Co-Chair of the Marketing Club. He recenly completed an advanced
        certification in Artificial Intelligence from Said Business School, Oxford University.
      </p>
      <h2>Career</h2>
