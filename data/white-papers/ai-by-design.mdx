---
title: 'AI by Design: A Technical Program Manager’s Playbook for Modern Architecture'
date: '2025-01-09'
tags: ['AI/ML', 'Architecture', 'Program Managemnt', 'Product Design']
draft: false
summary: This white paper explores how AI/ML technology is affecting the role of TPM and how it affects product design in the near future
---
...
| **Dimension**                   | **Classical ML**                                                                   | **Early Deep Learning**                                                                                             | **Advanced LLMs** <br/>_e.g., ChatGPT, GPT-4_                                                                                     | **AutoGen / Multi-Agent AI** <br/>_e.g., multi-step orchestrators_                                                                     |
| :------------------------------ | :--------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------ | :-------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------- |
